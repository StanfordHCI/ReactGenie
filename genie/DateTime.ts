import {GenieClass, HelperClass, GenieProperty, GenieFunction} from "reactgenie-dsl";
...
export class DateTime extends HelperClass {
    ...
    constructor({year = undefined, month = undefined, day = undefined, hour = undefined, minute = undefined, second = undefined}:
    ...
    CreateDatetime({year = undefined, month = undefined, day = undefined, hour = undefined, minute = undefined}:
                       { year?: number, month?: number, day?: number, hour?: number, minute?: number}): DateTime {
    ...
    addDateOffset({year = 0, month = 0, day = 0, hour = 0, minute = 0, second = 0}:
